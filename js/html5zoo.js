            ...
            createNav: function() {
                ...
                if (this.options.navstyle != 'none') {
                    ...
                    if (this.options.navshowpreview) {
                        ...
                        var z = $("<div class='html5zoo-nav-preview-img-" + this.id + "' style='display:block;position:relative;width:100%;height:100%;overflow:hidden;' />");
                        x.append(y);
                        x.append(z);
            ...
            createNavBullet: function(r) {
                ...
                x.hover(function() {
                    ...
                    if (s.options.navshowpreview) {
                        ...
                        var f = $(".html5zoo-nav-preview-img-" + s.id, e);
